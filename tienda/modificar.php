...
if(!isset($_GET['id'])) {
  header('Location: elegirModificar.php');
  exit;
}
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <div class="container">
      ...
      <div class="row">
        <form role="form" action="procesarModArticulo.php" method="post">

          <input type="hidden" name="id" value="<?php echo $iId; ?>">
          
          <div class="form-group">
            <label for="nombre">Nombre</label>
            <input type="text" class="form-control" name="nombre" id="nombre" placeholder="El nombre" value="<?php echo $sNom; ?>">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="color" class="form-control" name="color" placeholder="El color"  value="<?php echo $sColor; ?>">
          </div>
          <div class="form-group">
            <label for="talla">Talla</label>
            <input type="number" class="form-control" name="talla" id="talla" placeholder="La talla"  value="<?php echo $iTalla; ?>">
          </div>
          <div class="form-group">
