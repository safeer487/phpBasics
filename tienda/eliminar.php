...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <div class="container">
      ...
      if(isset($_GET['eliminado'])) {
        echo '<div class="alert alert-success">Artículo eliminado.</div>';
      }
          ...
          <table class="table">
            ...
            while($row = mysql_fetch_assoc($resultados)) {
              ...
              echo "<tr>
                      ...
                      <td>$iTalla</td>
                      <td>$iGen</td>
                      <td><a href='procesarEliminar.php?id=$iId'><button type='button' class='btn btn-danger'>Eliminar</button></a></td>
                    </tr>";
            }
            ?>
